...
const emit = defineEmits<{
  submit: [data: z.infer<typeof POSTProductSchema>]
}>()
...
<template>
  <form @submit="onSubmit" class="flex flex-col gap-y-3">
    <FormField v-slot="{ componentField }" name="sku">
      <FormItem>
        <FormLabel asterisk> SKU </FormLabel>
        <FormControl>
          <Input :disabled="type === 'put'" placeholder="Product SKU" v-bind="componentField" />
        </FormControl>
        <FormDescription v-if="type === 'put'"> SKU can't be edited </FormDescription>
        <FormMessage />
      </FormItem>
    </FormField>
    ...
    <FormField v-slot="{ componentField }" name="description">
      <FormItem>
        ...
        <FormControl>
          <Textarea placeholder="Product Description" v-bind="componentField" />
        </FormControl>
        <FormMessage />
      </FormItem>
    </FormField>
    ...
    <div class="grid grid-cols-2 gap-x-3">
      <FormField v-slot="{ componentField }" name="uom">
        <FormItem>
          <FormLabel asterisk> UOM </FormLabel>
          <FormControl>
            <Input placeholder="UOM" v-bind="componentField" />
          </FormControl>
          <FormMessage />
        </FormItem>
      </FormField>
      ...
      <FormField v-slot="{ componentField }" name="stock">
        <FormItem>
          <FormLabel asterisk> Stock </FormLabel>
          <FormControl>
            <Input type="number" placeholder="Stock" v-bind="componentField" />
          </FormControl>
          <FormMessage />
        </FormItem>
      </FormField>
